...
<html lang="en">
  ...
  <body>
    <div class="container px-5 mx-auto text-left">
      ...
      <h2 class="text-4xl mt-16 mb-8 text-[#212830] font-display">The tragedy of an old Node project</h2>
      <p class="text-lg mb-7 leading-8 text-[#212830] font-serif">
      ...
      <h2 class="text-4xl mt-16 mb-8 text-[#212830] font-display">The trap of dependencies in JavaScript projects</h2>
      <p class="text-lg mb-7 leading-8 text-[#212830] font-serif">
      ...
      <h2 class="text-4xl mt-16 mb-8 text-[#212830] font-display">Don't neglect the foundation of your software</h2>
      <p class="text-lg mb-7 leading-8 text-[#212830] font-serif">
