...
<div class="text-center mb-14">
  ...
  ?>
  <ul class="flex justify-center space-x-4 text-sm uppercase font-sans font-medium tracking-widest">
    <li class="relative">
    ...
    <li class="relative">
      ...
      <?php
        if (str_starts_with($location, '/blog')) {
          echo '<div class="absolute w-full h-2 bg-[#FFFF81] -mt-2 -z-10"></div>';
        }
      ?>
    </li>
    ...
    <li class="relative">
      ...
      <?php
        if (str_starts_with($location, '/about')) {
          echo '<div class="absolute w-full h-2 bg-[#FFFF81] -mt-2 -z-10"></div>';
        }
      ?>
    </li>
